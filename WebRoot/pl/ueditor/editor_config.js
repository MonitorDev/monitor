...
(function () {
    ...
    var URL = window.UEDITOR_HOME_URL || Cfg.path + 'pl/ueditor/';
    ...
    UEDITOR_CONFIG = {
        ...
        toolbars:[
            ['Heading1','FullScreen', 'Source', '|', 'Undo', 'Redo', '|',
        ...
        labelMap:{
            'heading1':'一级目录','anchor':'锚点', 'undo':'撤销', 'redo':'重做', 'bold':'加粗', 'indent':'首行缩进','snapscreen': '截图',
