...
public class SnmpUtil {   
    ...
    public void initComm() throws IOException {   
        // 设置Agent方的IP和端口   
         targetAddress = GenericAddress.parse("udp:192.168.4.150/161");   
    ...
    public void readResponse(ResponseEvent respEvnt) {   
        ...
        if (respEvnt != null && respEvnt.getResponse() != null) {   
             Vector<VariableBinding> recVBs = (Vector<VariableBinding>) respEvnt.getResponse().getVariableBindings();//respEvnt.getResponse().getVariableBindings();   
