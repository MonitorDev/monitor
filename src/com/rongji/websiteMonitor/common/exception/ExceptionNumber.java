...
public class ExceptionNumber {
	...
	public static final int ERR_WCMEXCEPTION = 1000;
	...
	public static String getErrNumMsg(int exceptionNum) {
		String exceptionMsg = ExceptionMessages.getString(exceptionNum);
