...
/**
 * 作用解析${...}
 * 代码来源于spring 2.5.6 中的PropertyPlaceholderConfigurer
 * @author rjf
 *
 */
public class PlaceholderResolving {
	...
	public PlaceholderResolving(Properties props) {
		this.props = props;
	}
	...
	private static final Logger logger = Logger.getLogger(PlaceholderResolving.class);
